...
class Roi(BaseModel):
    ...
    spatial_features_group_name: str = Field(
        ...,
        description="Name of the spatial features group in EarthRanger whose polygons define the regions of interest.",
        title="Spatial Features Group",
    )
...
class FormData(BaseModel):
    ...
    time_range: Optional[TimeRange] = Field(
        None,
        description="Choose the period of time to analyze. Please make sure you select a large enough time range to see results, as the latest month's data may not be ready yet.",
        title="Time Range",
    )
    ...
    NDVI_Map: Optional[NDVIMap] = Field(
        None,
        alias="NDVI Map",
